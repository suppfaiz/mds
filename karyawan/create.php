<?php
$path_prefix = '../';
$page_title = 'Tambah Data Karyawan';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nik) || empty($nama) || empty($jabatan) || empty($no_hp) || empty($alamat)) {
        ...
        try {
            ...
            $check_stmt = $pdo->prepare("SELECT COUNT(*) FROM karyawan WHERE nik = ?");
            ...
            if ($check_stmt->fetchColumn() > 0) {
                ...
                if (empty($error)) {
                    ...
                    $stmt->execute([
                        $nik, $nama, $jabatan, $no_hp, $email, $alamat, $foto_db_path
                    ]);
                    
                    $karyawan_id = $pdo->lastInsertId();
                    logActivity($pdo, 'Tambah Karyawan', 'Menambahkan karyawan: ' . $nama . ' (NIK: ' . $nik . ', ID: ' . $karyawan_id . ')');
                    
                    $_SESSION['success_message'] = 'Data karyawan ' . htmlspecialchars($nama) . ' berhasil disimpan.';
...
<div class="d-flex align-items-center gap-2 mb-3">
    ...
    <h4 class="fw-bold mb-0">Tambah Data Karyawan</h4>
</div>
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukkan 16 digit NIK" value="<?php echo isset($_POST['nik']) ? htmlspecialchars($_POST['nik']) : ''; ?>" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="jabatan" name="jabatan" required>
                                ...
                                <option value="Staf TU (Tata Usaha)" <?php echo (isset($_POST['jabatan']) && $_POST['jabatan'] === 'Staf TU (Tata Usaha)') ? 'selected' : ''; ?>>Staf TU (Tata Usaha)</option>
                                <option value="Staf Perpustakaan" <?php echo (isset($_POST['jabatan']) && $_POST['jabatan'] === 'Staf Perpustakaan') ? 'selected' : ''; ?>>Staf Perpustakaan</option>
                                <option value="Laboran" <?php echo (isset($_POST['jabatan']) && $_POST['jabatan'] === 'Laboran') ? 'selected' : ''; ?>>Laboran</option>
                                <option value="Petugas Keamanan" <?php echo (isset($_POST['jabatan']) && $_POST['jabatan'] === 'Petugas Keamanan') ? 'selected' : ''; ?>>Petugas Keamanan</option>
                                <option value="Petugas Kebersihan" <?php echo (isset($_POST['jabatan']) && $_POST['jabatan'] === 'Petugas Kebersihan') ? 'selected' : ''; ?>>Petugas Kebersihan</option>
                                <option value="Supir" <?php echo (isset($_POST['jabatan']) && $_POST['jabatan'] === 'Supir') ? 'selected' : ''; ?>>Supir</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="Contoh: 08123456789" value="<?php echo isset($_POST['no_hp']) ? htmlspecialchars($_POST['no_hp']) : ''; ?>" required>
                        </div>

                        <div class="col-md-12">
                            <label for="email" class="form-label fw-semibold small">Alamat Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Contoh: nama@domain.com" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>">
                        </div>
                        
                        <div class="col-12">
                            <label for="alamat" class="form-label fw-semibold small">Alamat Tinggal <span class="text-danger">*</span></label>
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap rumah..." required><?php echo isset($_POST['alamat']) ? htmlspecialchars($_POST['alamat']) : ''; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card shadow-sm border-0 mb-4 text-center">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <label for="foto" class="form-label fw-semibold small">Unggah Berkas Foto</label>
            ...
            <div class="card shadow-sm border-0 mb-4 p-3 bg-light">
                <button type="submit" class="btn btn-primary w-100 fw-bold mb-2"><i class="bi bi-save"></i> Simpan Data</button>
